...
const FEMALE_NAMES=[
  ["Daisy","cheerful flower - #1 female name"],
  ...
  ["Sadie","princess - sweet"],
  ["Maggie","pearl - gentle"],
  ["Zoe","life - vibrant"],
  ["Lulu","pearl - playful"],
  ["Penny","weaver - loyal"],
  ["Gracie","graceful - charming"],
  ["Winnie","peaceful - English charm"],
  ["Ellie","light - happy"],
  ["Bailey","bailiff - strong"],
  ["Holly","holly tree"],
  ["Dolly","gift of God"],
  ["Roxy","dawn - bright"],
  ...
  ["Hattie","ruler of home"],
  ["Ivy","faithful - clinging"]
];

const MALE_NAMES=[
  ["Winston","joyful stone - #1 Bulldog name"],
  ["Max","the greatest"],
  ["Charlie","free-spirited"],
  ["Oliver","olive tree - classic"],
  ["Duke","noble leader"],
  ["Tank","strong & sturdy"],
  ["Rocky","restful - tough"],
  ["Gus","great one - endearing"],
  ["Jax","God is gracious"],
  ["Henry","ruler of the house"],
  ["Bear","strong & brave"],
  ["Rufus","red-haired - distinguished"],
  ["Milo","soldier - gentle"],
  ["Oscar","divine spear"],
  ["Bentley","meadow - regal"],
...
function copyLink(el){
  navigator.clipboard.writeText('https://puppynamegenerator.net/bulldog/').then(()=>{

...
const FEMALE_NAMES=[
  ["Bella","classic short-leg beauty"],
  ["Daisy","cheerful little bloom"],
  ["Luna","moonlit corgi girl"],
  ["Lucy","bright little spark"],
  ["Sadie","sweet royal princess"],
  ["Maggie","gentle farm girl"],
  ["Sophie","wise & lovely lady"],
  ["Stella","shining little star"],
  ["Rosie","rosy round face"],
  ["Willow","graceful & slim"],
  ["Penny","copper-coated cutie"],
  ["Ruby","ruby-red gem"],
  ["Honey","golden & sweet"],
  ["Piper","peppy little music"],
  ["Lady","noble herding heart"],
  ["Duchess","tiny royal grace"],
  ["Ellie","shining short girl"],
  ["Gracie","soft & elegant"],
  ["Poppy","bright little bloom"],
  ["Winnie","happy farm friend"],
  ["Biscuit","golden low rider"],
  ["Hazel","warm-eyed beauty"],
  ["Olive","calm & peaceful"],
  ["Cocoa","chocolate-coated charm"],
  ["Tilly","tiny little farmer"],
  ["Millie","strong country girl"],
  ["Maple","autumn-leaf cutie"],
  ["Toffee","caramel sweet treat"],
  ["Gigi","regal little diva"],
  ["Annie","gracious country gal"],
  ["Lily","pure & pretty"],
  ["Phoebe","bright little star"],
  ["Ivy","loyal little climber"],
  ["Cora","maiden of the heart"],
  ["Emma","universal sweetheart"],
  ["Fiona","fair Welsh lass"],
  ["Gwen","fair little one"],
  ["Seren","Welsh for star"],
  ["Carys","beloved Welsh pick"],
  ["Bronwyn","white-breasted beauty"],
  ["Taffy","sweet Welsh touch"],
  ["Megan","Welsh pearl"],
  ["Holly","festive & bright"],
  ["Nala","lioness at heart"],
  ["Zoe","lively little life"],
  ["Chloe","blooming pretty girl"],
  ["Lola","spunky little lady"],
  ["Molly","star of the farm"],
  ["Bonnie","pretty & cheerful"],
  ["Minnie","tiny sweetheart"]
];

const MALE_NAMES=[
  ["Max","the greatest little guy"],
  ["Charlie","friendly charmer"],
  ["Cooper","plucky little buddy"],
  ["Buddy","loyal best friend"],
  ["Bear","fluffy & brave"],
  ["Toby","happy herding pal"],
  ["Duke","noble short king"],
  ["Oscar","bold little actor"],
  ["Archie","true & bold"],
  ["Leo","brave little lion"],
  ["Henry","little gentleman"],
  ["Gus","great big spirit"],
  ["Rex","king of the couch"],
  ["Tucker","merry little herder"],
  ["Winston","stately little guy"],
  ["Bentley","little meadow lord"],
  ["Dexter","clever & quick"],
  ["Murphy","happy little rascal"],
  ["Boomer","big little personality"],
  ["Buster","tough tiny fellow"],
  ["George","gentleman farmer"],
  ["Otis","calm & friendly"],
  ["Benny","blessed little pal"],
  ["Cody","helpful herding pup"],
  ["Rusty","red-coated corgi"],
  ["Harvey","battle-ready buddy"],
  ["Scout","trail explorer"],
  ["Ace","number-one corgi"],
  ["Captain","leader of the pack"],
  ["Ranger","outdoor herder"],
  ["Bandit","mischievous mask"],
  ["Owen","young little warrior"],
  ["Dylan","tide of greatness"],
  ["Gareth","gentle Welsh lad"],
  ["Bryn","Welsh for hill"],
  ["Idris","fiery little lord"],
  ["Tudor","ruler of corgis"],
  ["Taffy","sweet Welsh touch"],
  ["Emrys","wise Welsh sage"],
  ["Trefor","big village lad"],
  ["Gwilym","determined spirit"],
  ["Rhys","enthusiastic spirit"],
  ["Sammy","happy-go-lucky pup"],
  ["Teddy","cuddly little bear"],
  ["Finn","fair little adventurer"],
  ["Loki","mischievous little god"],
  ["Bo","tiny buddy"],
  ["Clyde","bold country boy"],
  ["Frankie","fun farm fellow"],
  ["Rascal","playful troublemaker"]
];
...
function copyLink(el){
  navigator.clipboard.writeText('https://puppynamegenerator.net/welshcorgi/').then(()=>{

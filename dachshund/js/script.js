...
const FEMALE_NAMES=[
  ["Bella","beautiful - top pick"],
  ["Daisy","cheerful little flower"],
  ["Luna","moonlit charmer"],
  ["Sadie","sweet princess"],
  ["Sophie","wise & gentle"],
  ["Chloe","blooming beauty"],
  ["Rosie","rosy as her coat"],
  ["Lucy","little light"],
  ["Zoey","full of life"],
  ["Lola","spunky & playful"],
  ["Penny","copper penny"],
  ...
  ["Stella","shining star"],
  ["Piper","musical pup"],
  ["Willow","slim & graceful"],
  ["Olive","peaceful spirit"],
  ["Honey","golden sweetness"],
  ["Lily","soft as a petal"],
  ["Roxy","dawn energy"],
  ["Ginger","spicy & warm"],
  ["Millie","mighty girl"],
  ["Coco","chocolate-brown coat"],
  ["Dixie","southern charm"],
  ["Nala","queenly lioness"],
  ["Maya","gentle illusion"],
  ["Heidi","noble German heritage"],
  ["Greta","precious pearl"],
  ["Gretchen","little pearl"],
  ["Liesl","pledged to God"],
  ["Frida","peaceful Frida"],
  ["Molly","star of the sea"],
  ["Maggie","pearl of the house"],
  ["Layla","night beauty"],
  ["Abby","father's joy"],
  ...
  ["Vienna","vintage charm"],
  ["Lady","true lady"],
  ["Precious","beloved treasure"],
  ["Emma","universal love"],
  ["Annie","graceful friend"],
  ["Lexi","little defender"],
  ["Sasha","loyal helper"],
  ["Mimi","French sweetness"],
  ["Lulu","pearl of fun"],
  ["Bridget","strong & bright"],
...
const MALE_NAMES=[
  ...
  ["George","trustworthy farmer"],
  ["Winston","joyful stone"],
  ["Sammy","loyal listener"],
  ["Bear","strong as can be"],
  ["Frank","honest fellow"],
  ["Otto","wealthy little one"],
  ["Hans","gracious gift"],
  ["Fritz","peaceful ruler"],
  ["Klaus","triumphant spirit"],
  ["Wolfgang","traveling wolf"],
  ["Dieter","people's army"],
  ["Werner","brave warrior"],
  ["Herman","man of the army"],
  ["Gunther","bold warrior"],
  ["Loki","mischievous god"],
  ["Dexter","clever right hand"],
  ["Buster","tough cookie"],
  ["Chester","little fortress"],
  ["Ziggy","victorious"],
  ["Frankie","free & easy"],
  ["Rusty","reddish glow"],
  ["Rex","royal king"],
...
function copyLink(el){
  navigator.clipboard.writeText('https://puppynamegenerator.net/dachshund/').then(()=>{

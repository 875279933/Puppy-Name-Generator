...
const FEMALE_NAMES=[
  ["Coco","sweet chocolate - #1 Bichon name"],
  ["Bella","beautiful - classic choice"],
  ["Daisy","cheerful flower"],
  ["Sophie","wisdom - elegant choice"],
  ["Lulu","pearl - playful & cute"],
  ["Molly","star of the sea"],
  ["Lucy","light - friendly"],
  ["Gigi","French elegance"],
  ["Chloe","blooming beauty"],
  ["Luna","moon goddess"],
  ["Rosie","rose flower"],
  ["Maggie","pearl - sweet"],
  ["Cotton","fluffy white coat"],
  ["Snowball","white as snow"],
  ["Mimi","French charm"],
...
function copyLink(el){
  navigator.clipboard.writeText('https://puppynamegenerator.net/bichon-frise/').then(()=>{
